...
/**
 * Testing Class for RedComponent.
 */
public class RedComponentTest {
  private ImageOperation op = new RedComponent();
  ...
  public void init() {
    ...
    Pixel redpalt = new Pixel(255, 255, 255);
    Pixel orangepalt = new Pixel(255, 255, 255);
    Pixel pinkpalt = new Pixel(255, 255, 255);
    Pixel yellowpalt = new Pixel(255, 255, 255);
    Pixel bluepalt = new Pixel(0, 0, 0);
