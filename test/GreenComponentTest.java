...
/**
 * Testing Class for GreenComponent.
 */
public class GreenComponentTest {
  private ImageOperation op = new GreenComponent();
  ...
  public void init() {
    ...
    Pixel orangepalt = new Pixel(128, 128, 128);
    Pixel pinkpalt = new Pixel(128, 128, 128);
    Pixel yellowpalt = new Pixel(225, 225, 225);
    Pixel bluepalt = new Pixel(150, 150, 150);
